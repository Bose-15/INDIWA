    ...
    <div className="bg-white">
      ...
      <section className="relative pt-24 pb-16 border-b border-gray-100 overflow-hidden">
        ...
        <div className="container-tight px-6 text-center">
          ...
          >
            <Rocket size={16} className="text-brand-green animate-pulse" /> The National Movement
          </motion.div>

          <div className="space-y-6 max-w-4xl mx-auto">
            <span className="font-script text-brand-red text-3xl md:text-4xl block transform -rotate-1">BECOME A PART OF IT</span>
          ...
          <div className="flex flex-col lg:flex-row items-stretch gap-16 lg:gap-16">
                ...
                <div className="flex items-center gap-8 group p-8 rounded-ultra bg-slate-50 border border-gray-50 hover:bg-white hover:shadow-premium transition-all">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-lg font-black text-gray-900 tracking-tight">
                      Mon - Fri | <span className="text-brand-green">8 AM - 5 PM</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="relative h-full min-h-[500px] md:min-h-[700px] rounded-ultra overflow-hidden shadow-premium border-[12px] border-slate-50 group">
                ...
                {/* Elite Badge Overlay */}
                <div className="absolute top-4 left-4 md:top-10 md:left-10 glass p-3 md:p-8 rounded-2xl md:rounded-ultra shadow-2xl max-w-[140px] md:max-w-[220px] backdrop-blur-xl border border-white/40">
                  <div className="w-8 h-8 md:w-10 md:h-10 bg-brand-green text-white rounded-lg md:rounded-xl flex items-center justify-center mb-3 md:mb-4 shadow-glow">
                    <Trophy className="w-4 h-4 md:w-5 md:h-5" />
                  </div>
                  <h4 className="text-sm md:text-xl font-black text-gray-900 uppercase tracking-tight mb-1 md:mb-2 leading-none">India's Largest</h4>
                  <p className="text-[7px] md:text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] leading-none">Networkers Welfare Association</p>
                </div>
              ...
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-brand-green/10 blur-3xl rounded-full -z-10" />
        ...
        <div className="container-tight px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <h2 className="text-white text-4xl md:text-5xl uppercase tracking-tighter leading-none">One Hub for <br /><span className="text-brand-green">All Your Queries.</span></h2>
