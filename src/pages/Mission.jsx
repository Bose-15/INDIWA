               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-16 items-center">
                  <div className="relative group">
                     ...
                     <div className="absolute bottom-4 right-4 md:-bottom-12 md:-right-10 glass p-5 md:p-12 rounded-2xl md:rounded-ultra shadow-glow-blue max-w-[200px] md:max-w-[320px] z-30">
                        ...
                        <h4 className="text-lg md:text-2xl font-black text-gray-900 uppercase tracking-tight mb-2 md:mb-4 leading-none">Building Futures.</h4>
         ...
         <section className="section-padding bg-slate-900 text-white relative overflow-hidden">
            ...
            <div className="container-tight px-6 relative z-10 text-center">
               <div className="max-w-4xl mx-auto space-y-16">
                  <div className="space-y-6">
                     <span className="font-script text-brand-red text-3xl md:text-4xl block transform -rotate-1">Our Mission</span>
            ...
            <div className="container-tight px-6">
               <div className="bg-brand-gradient rounded-ultra p-16 md:p-24 relative overflow-hidden shadow-glow-blue group">
                  ...
                  <div className="relative z-10 max-w-4xl mx-auto space-y-12">
                     <h2 className="text-4xl md:text-6xl uppercase tracking-tighter mb-8 text-white leading-none">Join a Legacy of <br /><span className="text-brand-green underline decoration-[6px] underline-offset-[12px]">Purpose & Trust.</span></h2>
